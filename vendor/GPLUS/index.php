...
$client->setClientId('XXXXXXXXXXXXXXXXXXXXX'); // paste the client id which you get from google API Console
$client->setClientSecret('XXXXXXXXXXXXXXX'); // set the client secret
