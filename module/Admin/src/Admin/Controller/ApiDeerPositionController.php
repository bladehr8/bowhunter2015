...
use Admin\Form\DeerPositionForm;       
...
class ApiDeerPositionController extends AbstractRestfulController
{
	
		protected $deeraPositionTable;
		protected $restApiKey = "AXDFG65432@789GAME#987";
		
		public function getTable()
		{
			if (!$this->deeraPositionTable) {
				$sm = $this->getServiceLocator();
				$this->deeraPositionTable = $sm->get('Admin\Model\DeerPositionTable');
			}
			return $this->deeraPositionTable;
		}
		...
		public function get($id)
		{
			...
			{				
				...
				return new JsonModel(array('errors' => array($errorJson)));	
				//return new JsonModel(  array( 'errors' =>  array( 'error' => true,'message' => "Content ID $id does not exist " ) ));
			}	
			else
			{	
