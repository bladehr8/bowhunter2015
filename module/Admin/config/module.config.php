...
return array(
    'controllers' => array(
        'invokables' => array(
			...
			'Admin\Controller\ApiBankReport' 		=> 'Admin\Controller\ApiBankReportController',			
			'Admin\Controller\ApiBuyConsumables' 	=> 'Admin\Controller\ApiBuyConsumablesController',
            'Admin\Controller\ApiPlayerActivityDemo' 		        => 'Admin\Controller\ApiPlayerActivityDemoController',#added By Dibyendu to check player details (Demo version)
    ...
    'router' => array(
		...
		'ad-report' => array(
			...
			'api-bankreport' => array(
					'type'    => 'segment',
					'options' => array(
								'route'    		=> '/admin/api-bankreport[/:action][/:id]',
								'constraints' 	=> array(	
															'action' => '[a-zA-Z][a-zA-Z0-9_-]*',	
															'id'     => '[0-9]+',
														),
					'defaults' 		=> array(
												'controller' 	=> 'Admin\Controller\ApiBankReport',					
											),
					),
			),				
			
			
			'api-buy-consumables' => array(
					'type'    => 'segment',
					'options' => array(
								'route'    		=> '/admin/api-buy-consumables[/:action][/:id]',
								'constraints' 	=> array(	
															'action' => '[a-zA-Z][a-zA-Z0-9_-]*',	
															'id'     => '[0-9]+',
														),
					'defaults' 		=> array(
												'controller' 	=> 'Admin\Controller\ApiBuyConsumables',					
											),
					),
			),				
			...
			'api-short-target' => array(
                ...
                #Added by dibyendu for demo version check starts
            'api-player-activity-demo' => array(
					'type'    => 'segment',
					'options' => array(
								'route'    		=> '/admin/api-player-activity-demo[/:id]',
								'constraints' 	=> array(	
															
															'id'     => '[a-zA-Z][a-zA-Z0-9_-]*',
														),
					'defaults' 		=> array(
												'controller' 	=> 'Admin\Controller\ApiPlayerActivityDemo',					
											),
					),
			),	
             #Added by dibyendu for demo version check ends
			...
			'deerinfo' => array(
				...
				'mail' => array(
						...
						'options' => array(
							...
							'defaults' => array(
											'controller' => 'Admin\Controller\Mail',
											'action'     => 'index',
											),
						),
			),
